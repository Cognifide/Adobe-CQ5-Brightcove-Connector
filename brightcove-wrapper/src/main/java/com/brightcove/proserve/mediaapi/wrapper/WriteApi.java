	...
	public Long CreateVideo(String writeToken, Video video, String filename, TranscodeEncodeToEnum encodeTo, Boolean createMultipleRenditions, Boolean preserveSourceRendition, Boolean h264NoProcessing) throws BrightcoveException {
		if(log != null){
			if(video.getCreationDate() != null){
				log.warn("Field \"Creation Date\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getFlvUrl() != null){
				log.warn("Field \"FLV URL\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getLastModifiedDate() != null){
				log.warn("Field \"Last Modified Date\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getLength() != null){
				log.warn("Field \"Length\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getPlaysTotal() != null){
				log.warn("Field \"Plays Total\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getPlaysTrailingWeek() != null){
				log.warn("Field \"Plays Trailing Week\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getPublishedDate() != null){
				log.warn("Field \"Published Date\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getThumbnailUrl() != null){
				log.warn("Field \"Thumbnail URL\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(video.getVideoStillUrl() != null){
				log.warn("Field \"Video Still URL\" is set on the video, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
		}
	...
	public Long CreatePlaylist(String writeToken, Playlist playlist) throws BrightcoveException {
		if(log != null){
			if(playlist.getAccountId() != null){
				log.warn("Field \"Account Id\" is set on the playlist, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(playlist.getId() != null){
				log.warn("Field \"Id\" is set on the playlist, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(playlist.getThumbnailUrl() != null){
				log.warn("Field \"Thumbnail URL\" is set on the playlist, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(playlist.getVideoIds() != null){
				log.warn("Field \"Video Ids\" is set on the playlist, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
			if(playlist.getVideos() != null){
				log.warn("Field \"Videos\" is set on the playlist, but this can not be set by the Media API.  This will be passed through to the Media API, but it will be ignored.");
			}
		}

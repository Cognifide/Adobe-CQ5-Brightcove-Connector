...
if (customBC == undefined) {
    ...
    // jkubiczak 2014-07-25
    // while working on some other bug (multiple videos not working on IE8, IE9)
    // i tried to debug this script but it is not executed.
    // only the content generated by JSP page is used for showing videos.
    //
    // TODO: this script is not executed
    //
    // TODO: scripts in brightcoveExperiences2 folder are work in progress (they are not executed also)
    //

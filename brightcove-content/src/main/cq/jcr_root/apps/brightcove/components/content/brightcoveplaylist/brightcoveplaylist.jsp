...
<%@ page import="com.day.cq.wcm.api.components.DropTarget,com.brightcove.proserve.mediaapi.webservices.*,java.util.UUID"%>
<%
...
<cq:include script="brightcoveplaylistui.jsp"/>

<% if (properties.get("videoPlayerPL", "").isEmpty()) {%>
    <cq:include script="/apps/brightcove/components/content/brightcoveplaylist/empty.jsp"/>
<% } else { %>
